...
struct spectra {
  ...
  double * poissonratio; // Robert Alessio, Ratio of the Poissonequation
  
  double * PhiOverPsi; // Robert Alessio, Gravitational Slip
  
  double * growthfac; // Robert Alessio, growthfactor of matter power spectrum

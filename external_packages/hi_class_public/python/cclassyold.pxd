...
cdef extern from "class.h":
    ...
    double poissonratio_at_k_and_z (background * pba, spectra * psp, perturbs *ppt, double k, double z, double * pk_ic)   
        
    double * poissonratio
    
    double * PhiOverPsi
    
    int ratio(background * pba, perturbs * ppt, spectra * psp, double z, double * output) 
  
    int poissonratio_at_k_and_z (background * pba, spectra * psp, perturbs *ppt, double k, double z, double * pk_ic, double * output)
  
    int ratioPhiPsi(background * pba, perturbs * ppt, spectra * psp, double z, double * output)

    int PhiPsiratio_at_k_and_z(background * pba, spectra * psp, perturbs *ppt, double k, double z, double * pk_ic, double * output)
                                     
    int matterdens_at_z(background * pba, perturbs * ppt, spectra * psp, double z, double * output) 
    
    double matterdens_at_z_and_k(background * pba, spectra * psp, perturbs *ppt, double k, double z, double * pk_ic, double * output)
    
    double hubble_at_z(background *pba, spectra * psp, double z);      
